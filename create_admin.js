...
db.connect(err => {
    ...
    const nombre = 'Admininstrador Paula'; // Nombre del nuevo administrador
    const email = 'paula@outlook.com'; // Email del nuevo administrador
    const contraseña = 'Paula@1234'; // Contraseña del nuevo administrador (recuerda cambiarla por una segura)
